      ...
      <main class="flex-1 p-6 md:p-10 overflow-y-auto">
        ...
        <section>
          ...
          <div class="bg-gray-950/50 backdrop-blur-sm rounded-2xl border border-gray-800 shadow-2xl p-6 md:p-8">
            <form id="addBannerForm" class="space-y-6">
              <!-- Banner Information -->
              <div class="space-y-4">
              ...
              <div class="flex items-center justify-end pt-4 border-t border-gray-800">
                ...
                <button type="submit" class="text-white bg-blue-600 hover:bg-blue-700 focus:ring-4 focus:outline-none focus:ring-blue-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center">Add Banner</button>
              </div>
            </form>
          </div>
        </section>
