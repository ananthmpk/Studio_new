...
<head>
    ...
    <title>Add About Content - Admin Panel</title>
...
<body class="h-full">
      ...
      <main class="flex-1 p-6 md:p-10 overflow-y-auto">
        ...
        <section>
          <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-8">
            <div>
              <h1 class="text-3xl md:text-4xl font-extrabold text-white mb-1 flex items-center gap-3">
                <i class="ph ph-plus-circle"></i> Add About Content
              </h1>
              <div class="text-gray-400 text-sm">Create new content for your about page</div>
            </div>
          ...
          <div class="bg-gray-800 rounded-xl p-6 shadow-lg">
            <form id="addAboutForm" class="space-y-6">
              <div>
                <label for="contentTitle" class="block text-sm font-medium text-gray-300 mb-1">Title</label>
                <input type="text" id="contentTitle" name="contentTitle" class="w-full px-4 py-3 bg-gray-700 border border-gray-600 rounded-lg text-white focus:ring-2 focus:ring-blue-500 focus:border-blue-500" placeholder="Enter content title" required>
              </div>
              
              <div>
                <label for="contentDescription" class="block text-sm font-medium text-gray-300 mb-1">Description</label>
                <textarea id="contentDescription" name="contentDescription" rows="5" class="w-full px-4 py-3 bg-gray-700 border border-gray-600 rounded-lg text-white focus:ring-2 focus:ring-blue-500 focus:border-blue-500" placeholder="Enter detailed description" required></textarea>
              </div>
              
              <div>
                <label for="videoUrl" class="block text-sm font-medium text-gray-300 mb-1">Video URL (YouTube or Vimeo)</label>
                <input type="url" id="videoUrl" name="videoUrl" class="w-full px-4 py-3 bg-gray-700 border border-gray-600 rounded-lg text-white focus:ring-2 focus:ring-blue-500 focus:border-blue-500" placeholder="https://www.youtube.com/watch?v=...">
              </div>
              ...
              <div>
                ...
                <div class="grid grid-cols-6 gap-3">
                  <button type="button" class="flex flex-col items-center justify-center p-3 bg-gray-700 hover:bg-gray-600 rounded-lg transition">
                    ...
                    <span class="text-xs text-gray-300 mt-1">Info</span>
                  </button>
                  <button type="button" class="flex flex-col items-center justify-center p-3 bg-gray-700 hover:bg-gray-600 rounded-lg transition">
              ...
              <div class="flex justify-end gap-3">
                ...
                <button type="submit" class="px-5 py-2.5 bg-blue-600 hover:bg-blue-500 text-white rounded-lg transition flex items-center gap-2">
                  <i class="ph ph-check"></i> Save Content
                </button>
              </div>
            </form>
          </div>
    ...
    <script>
      document.getElementById('addAboutForm').addEventListener('submit', function(e) {
        e.preventDefault();
