            ...
            <div class="bg-gray-950/50 backdrop-blur-sm rounded-2xl border border-gray-800 shadow-2xl overflow-hidden">
              <div class="p-4">
                ...
                <div class="relative rounded-xl overflow-hidden mb-4">
                  <img id="preview-image" src="https://images.unsplash.com/photo-1519125323398-675f0ddb6308?auto=format&fit=crop&w=400&q=80" alt="Image preview" class="w-full aspect-square object-cover">
                </div>
                <div class="flex justify-center">
                  <label for="replace-image" class="cursor-pointer bg-gray-800 hover:bg-gray-700 text-gray-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center flex items-center gap-2">
                    ...
                    <input type="file" id="replace-image" class="hidden" accept="image/*">
                  </label>
                </div>
              </div>
            </div>
              ...
              <div class="p-6 md:p-8 space-y-6">
                <form class="space-y-6">
                  <div>
                    ...
                    <input type="text" id="title" value="Coastal Mist" class="w-full bg-gray-800 border border-gray-700 text-white rounded-lg px-4 py-3 focus:outline-none focus:ring-2 focus:ring-cyan-500">
                  </div>
                  <div>
                  ...
                  <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                      ...
                      <select id="category" class="w-full bg-gray-800 border border-gray-700 text-white rounded-lg px-4 py-3 focus:outline-none focus:ring-2 focus:ring-cyan-500">
                        ...
                        <option>Cars</option>
                        <option selected>Landscapes</option>
