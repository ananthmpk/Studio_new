            ...
            <form id="editTeamForm" class="space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div class="md:col-span-2 flex flex-col items-center">
                    <div class="w-24 h-24 rounded-full bg-gray-800 border-2 border-gray-700 flex items-center justify-center overflow-hidden mb-2">
                      <img id="profilePreview" src="https://randomuser.me/api/portraits/men/32.jpg" alt="Profile Preview" class="w-full h-full object-cover">
                    </div>
                  ...
                  <div>
                    ...
                    <input type="text" id="name" name="name" value="John Smith" class="w-full bg-gray-800 border border-gray-700 text-white rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-cyan-500" placeholder="John Smith" required>
                  </div>
                  
                  <!-- Email -->
                  <div>
                    <label for="email" class="block text-sm font-medium text-gray-300 mb-1">Email <span class="text-red-500">*</span></label>
                    <input type="email" id="email" name="email" value="john@example.com" class="w-full bg-gray-800 border border-gray-700 text-white rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-cyan-500" placeholder="john@example.com" required>
                  </div>
                  
                  <!-- Role -->
                  <div>
                    <label for="role" class="block text-sm font-medium text-gray-300 mb-1">Role <span class="text-red-500">*</span></label>
                    <input type="text" id="role" name="role" value="CEO & Founder" class="w-full bg-gray-800 border border-gray-700 text-white rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-cyan-500" placeholder="CEO & Founder" required>
                  </div>
              ...
              <div class="space-y-4">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div>
                    ...
                    <input type="url" id="facebook" name="facebook" value="https://facebook.com/johnsmith" class="w-full bg-gray-800 border border-gray-700 text-white rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-cyan-500" placeholder="https://facebook.com/username">
                  </div>
                  ...
                  <div>
                    ...
                    <input type="url" id="instagram" name="instagram" value="https://instagram.com/johnsmith" class="w-full bg-gray-800 border border-gray-700 text-white rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-cyan-500" placeholder="https://instagram.com/username">
                  </div>
                  ...
                  <div>
                    ...
                    <input type="tel" id="whatsapp" name="whatsapp" value="+1234567890" class="w-full bg-gray-800 border border-gray-700 text-white rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-cyan-500" placeholder="+1234567890">
                  </div>
                  ...
                  <div>
                    ...
                    <input type="url" id="linkedin" name="linkedin" value="https://linkedin.com/in/johnsmith" class="w-full bg-gray-800 border border-gray-700 text-white rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-cyan-500" placeholder="https://linkedin.com/in/username">
                  </div>
                </div>
              </div>
              ...
              <div class="space-y-4">
                ...
                <div>
                  ...
                  <textarea id="bio" name="bio" rows="4" class="w-full bg-gray-800 border border-gray-700 text-white rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-cyan-500" placeholder="Write a short bio...">John Smith is the CEO and Founder with over 15 years of experience in the industry. He leads the company's strategic vision and operations.</textarea>
                </div>
              </div>
              ...
              <div class="flex items-center justify-end pt-4 border-t border-gray-800">
                ...
                <button type="submit" class="text-white bg-blue-600 hover:bg-blue-700 focus:ring-4 focus:outline-none focus:ring-blue-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center">Update Team Member</button>
              </div>
            </form>
          </div>
        </section>
